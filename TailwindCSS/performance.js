// Performance measurement script for TailwindCSS prototype
(function() {
    'use strict';
    ...
    function saveMetrics() {
        ...
        try {
            localStorage.setItem('tailwindMetrics', JSON.stringify({
    ...
    function displayMetrics() {
        ...
        metricsDiv.innerHTML = `
            ...
            <div><strong>Framework:</strong> TailwindCSS</div>
        `;
    }
    ...
    window.tailwindMetrics = metrics;
})();
